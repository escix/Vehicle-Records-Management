...
// Revised: 
//   v2.0.4
//      - 02Apr2006 Snyder, Kenneth J. 73blazer@snyderworld.org 
//        - Added Forgot Password link
//   v2.1.0
//      - 23Feb2007 Snyder, Kenneth J. 73blazer@snyderworld.org
//        - Added Return code for demo account password update attempt
//
//==========================================================================
 ...
 <BODY>
  ...
  <CENTER>
   ...
   if (isset($rc) && $rc=="10") { 
    ...
    } elseif (isset($rc) && $rc=="40") {
     echo "<B><CENTER><font color=#ff0000>Sorry. Nice try. Demo account is not resetable</font></CENTER></B>";
   }
   ?>   
